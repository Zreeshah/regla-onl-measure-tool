...
const HomeContent: React.FC = () => {
  return (
    <div className="prose prose-sm md:prose-base lg:prose-lg max-w-none text-gray-700">
      ...
      <p>Si prefieres una versión en inglés para medir en centímetros o pulgadas, también puedes usar esta <a href="https://www.online-ruler.onl/" className="text-[#9b87f5] hover:underline">online ruler</a> gratuita desde cualquier navegador.</p>
      <p>Para complementar tus herramientas rápidas, puedes probar un <a href="https://www.dado-virtual.online/" className="text-[#9b87f5] hover:underline">dado virtual</a> para juegos o sorteos, y un <a href="https://www.lineal.onl/" className="text-[#9b87f5] hover:underline">lineal online</a> como alternativa sencilla para medir en pantalla.</p>
